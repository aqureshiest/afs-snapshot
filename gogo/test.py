def build_test_command(base):
    def test_command(args):
        if args.test_method == 'coverage':
            test_ci = base.build_command_func('docker-compose run --rm ci npm run test:coverage')
        elif args.test_method == 'watch':
